...
public class TambahdataPPU extends AppCompatActivity {
    public static final String url = "http://10.0.2.2/project_mou/insertppu.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambahdata_ppu);
