...
public class pksAdapterBerau extends RecyclerView.Adapter<pksAdapterBerau.HolderData>{
    private Context ctx;
    private List<DataBerau> listberau;

    public pksAdapterBerau(Context ctx, List<DataBerau> listberau){
        this.ctx = ctx;
        this.listberau = listberau;
    }

    @NonNull
    @Override
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_berau, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        DataBerau dm = listberau.get(position);
