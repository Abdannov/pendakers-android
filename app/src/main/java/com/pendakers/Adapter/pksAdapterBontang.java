...
public class pksAdapterBontang extends RecyclerView.Adapter<pksAdapterBontang.HolderData>{
    private Context ctx;
    private List<DataBontang> listbtg;

    public pksAdapterBontang(Context ctx, List<DataBontang> listbtg) {
        this.ctx = ctx;
        this.listbtg = listbtg;
    }

    @NonNull
    @Override
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_bontang, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        DataBontang dm = listbtg.get(position);
