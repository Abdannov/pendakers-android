...
public class pksAdapterKukar extends RecyclerView.Adapter<pksAdapterKukar.HolderData>{
    private Context ctx;
    private List<DataKukar> listkukar;

    public pksAdapterKukar(Context ctx, List<DataKukar> listkukar) {
        this.ctx = ctx;
        this.listkukar = listkukar;
    }

    @NonNull
    @Override
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_kukar, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        DataKukar dm = listkukar.get(position);
